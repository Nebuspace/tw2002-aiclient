...
|--------|-------|--------|-------|
| [`test_aiclient_play_panels.py`](/testing/cases/test-aiclient-play-panels.md) | 8 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Aiclient play panels. |
...
| [`test_cli_crawl_wiring.py`](/testing/cases/test-cli-crawl-wiring.md) | 3 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: `tw crawl` CLI verb wiring -- argparse only (dispatch itself needs a live daemon and is exercised at the protocol layer instead, see tests/test_crawl_start_protocol.py). |
| [`test_cli_haggle_wiring.py`](/testing/cases/test-cli-haggle-wiring.md) | 2 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: `tw haggle` CLI verb wiring -- argparse only (dispatch itself needs a live daemon and is exercised at the protocol layer instead, see tests/test_protocol_haggle.py). |
...
| [`test_cli_players.py`](/testing/cases/test-cli-players.md) | 20 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: `tw players` CLI verb tests -- no daemon involved, direct state/player_bank.json access (TW-31 client-side wiring, v1). |
...
| Module | Tests | Status | Blurb |
|--------|-------|--------|-------|
| [`test_crawl_start_protocol.py`](/testing/cases/test-crawl-start-protocol.md) | 6 | BANKED | protocol.py's `crawl_start` verb dispatch — no network; still `import twclient` (collection ERROR if un-ignored). Sibling bare-dispatch harnesses on tip: `tests/test_actor_attribution.py` (active). Historical sibling `test_protocol_haggle.py` is REMOVED. |
| [`test_menu_crawler.py`](/testing/cases/test-menu-crawler.md) | 63 | active | Menu Crawler tests (TW-26) -- no network, mock/fixture screens only. |
...
| [`test_world_identity.py`](/testing/cases/test-world-identity.md) | 13 | active | World identity. |
| [`test_world_model.py`](/testing/cases/test-world-model.md) | 53 | active | World model tests (TW-06) -- no network, tmp_path only, never touches the real state/ directory. |
| [`test_world_model_integration.py`](/testing/cases/test-world-model-integration.md) | 21 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: World model integration. |

## Game / Trade

| Module | Tests | Status | Blurb |
|--------|-------|--------|-------|
| [`test_game_data.py`](/testing/cases/test-game-data.md) | 5 | active | TW-24 game_data schema/loader tests. |
| [`test_game_data_persist.py`](/testing/cases/test-game-data-persist.md) | 25 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: TW-26/27 write lane -- persist/query path tests for `game_data.py`'s bridge over `game_knowledge.py`'s per-world "ships" game-data table. |
| [`test_game_knowledge.py`](/testing/cases/test-game-knowledge.md) | 43 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Game Knowledge Store tests (TW-25) -- no network, tmp_path only, never touches the real config/ or state/ directories. |
| [`test_game_knowledge_learned_rules.py`](/testing/cases/test-game-knowledge-learned-rules.md) | 6 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Learned-rule store tests — offline, tmp_path only. |
| [`test_haggle.py`](/testing/cases/test-haggle.md) | 16 | active | Haggle. |
...
| [`test_protocol_trainer_panel.py`](/testing/cases/test-protocol-trainer-panel.md) | 31 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Protocol trainer panel. |
...
| [`test_control_panel.py`](/testing/cases/test-control-panel.md) | 6 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Control panel. |
| [`test_credentials.py`](/testing/cases/test-credentials.md) | 28 | active | Secure credential store tests (DESIGN-v2 B2) — no network, tmp_path only, never touches the real config/ directory. |
...
| [`test_explore.py`](/testing/cases/test-explore.md) | 18 | active | TW-14 Map-fill / frontier explore planner tests. |
| [`test_fighter_toll_policy.py`](/testing/cases/test-fighter-toll-policy.md) | 16 | active | WO-FIGHTER-FLOOR-TOLL — fighter reserve + Option? |
| [`test_formations.py`](/testing/cases/test-formations.md) | 6 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: TW-16 formation detector tests. |
| [`test_frame_recorder.py`](/testing/cases/test-frame-recorder.md) | 5 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: WO-FRAMES-0 — frame recorder + build_response hook + CLI read path. |
...
| [`test_hud_seed.py`](/testing/cases/test-hud-seed.md) | 3 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: WO-HUD-CREDITS-TURNS-JOIN — cold-join I-probe + sticky turns. |
| [`test_iac.py`](/testing/cases/test-iac.md) | 12 | active | IAC stripping + negotiation tests — no network involved. |
| [`test_integration_introspect_persist.py`](/testing/cases/test-integration-introspect-persist.md) | 3 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: TW-26/27 introspector-to-persist chain integration test. |
| [`test_interactive_app.py`](/testing/cases/test-interactive-app.md) | 5 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Interactive app. |
| [`test_intervention_labels.py`](/testing/cases/test-intervention-labels.md) | 3 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Shared intervention label map — single source for play + spectate. |
| [`test_introspector.py`](/testing/cases/test-introspector.md) | 19 | active | TW-27 game-data introspector tests. |
| [`test_ledger.py`](/testing/cases/test-ledger.md) | 31 | active | Trace-Ledger tests (DESIGN-v2 §3 v2.1 item 11a, C1) -- no network, tmp_path only, never touches the real state/ directory. |
...
| [`test_login_redaction.py`](/testing/cases/test-login-redaction.md) | 13 | active | Cipher security gate (2026-07-20): sentinel-password redaction proof across the TW-02 `send_and_confirm` login/password swap (a2e99f6). |
| [`test_login_resume.py`](/testing/cases/test-login-resume.md) | 4 | active | Login resume. |
| [`test_miner.py`](/testing/cases/test-miner.md) | 12 | active | Miner. |
| [`test_mode_badge_vocabulary.py`](/testing/cases/test-mode-badge-vocabulary.md) | 9 | active | Mode badge vocabulary. |
| [`test_name_bank.py`](/testing/cases/test-name-bank.md) | 11 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Name bank tests (WO-MS-4 rider) -- no network, tmp_path only. |
...
| [`test_probe.py`](/testing/cases/test-probe.md) | 12 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: WO-MS-3 probe tests — classification, polite envelope, L0/L1 invariants. |
...
| [`test_replay_ledger_integration.py`](/testing/cases/test-replay-ledger-integration.md) | 4 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Replay ledger integration. |
| [`test_safe_addstr_choke.py`](/testing/cases/test-safe-addstr-choke.md) | 8 | active | Safe addstr choke. |
| [`test_servers.py`](/testing/cases/test-servers.md) | 7 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: WO-MS-1 server catalog tests. |
| [`test_settle.py`](/testing/cases/test-settle.md) | 25 | active | Settle-detection timing tests with a fake clock — no real sleeping. |
| [`test_ship_upgrade_decision.py`](/testing/cases/test-ship-upgrade-decision.md) | 10 | active | TW-30 ship-upgrade decision engine — unit coverage for all five §24 learnings. |
| [`test_skills.py`](/testing/cases/test-skills.md) | 50 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Skill record/replay + playback tests (DESIGN-v2 §3 v2.1 item 11b/11d, C3) -- no network. |
| [`test_state_parser.py`](/testing/cases/test-state-parser.md) | 62 | **REMOVED** | Deleted from tip (was BANKED archive/rehab inventory). Historical case file only. Original blurb: Best-effort state-extraction tests — no network involved. |
