---
type: Reference
title: Test Cases — test_watchfeed_wire
...
| `test_two_sequential_play_entries_start_and_stop_independent_feeds` | Re-entering the play shell (back, then play again) starts a FRESH feed each time -- no leaked state, no double-stop of a stale instance. |
