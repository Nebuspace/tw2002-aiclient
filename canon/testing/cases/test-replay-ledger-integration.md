...
| `test_replay_verb_refuses_a_mismatched_start_anchor_before_any_ledger_row` | Replay verb refuses a mismatched start anchor before any ledger row. |
| `test_replay_verb_force_waives_a_missing_legacy_start_anchor` | Replay verb force waives a missing legacy start anchor. |
