...
_Menu-map inspector — pure tests on synthetic maps._

| Test | Blurb |
|------|-------|
| `test_empty_map_zero_state` | Empty map zero state. |
| `test_linear_current_and_reachable` | Linear current and reachable. |
| `test_branching_and_cycle` | Branching and cycle. |
| `test_off_map_current_honest` | Off map current honest. |
| `test_orphan_node_is_isolated_island` | Orphan node is isolated island. |
