---
type: Reference
title: Test Cases — Cockpit Focus Pty
...
| `test_focus_composer_source_has_no_send_or_socket_surface` | Grep-level static check (PREP hard-gate): the FOCUS composer is. |
| `test_play_shell_screen_handle_key_unchanged_esc_and_q_only` | FOCUS wiring must not add any new key handling -- Esc still returns. |
