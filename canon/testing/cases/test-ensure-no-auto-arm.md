---
type: Reference
title: Test Cases — Ensure No Auto Arm
...
| `test_dispatch_ensure_never_arms_even_when_profile_would` | Bare ensure with autopilot-ish profile metadata still only logs in. |
