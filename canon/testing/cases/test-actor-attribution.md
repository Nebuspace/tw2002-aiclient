---
type: Reference
title: Test Cases — Actor Attribution
...
| `test_take_human_flips_mode_to_human_for_attribution_consumers` | Until ledger/_current_actor land, mode + last_sender are the dual. |
