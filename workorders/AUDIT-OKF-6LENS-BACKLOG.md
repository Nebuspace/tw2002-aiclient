...
| Banked session-audit | F7–F8 · classify coverage gap · login-redaction suite | F6 **DONE** `c21cd1c` · login-redaction **DONE** `6278c1e` · F7/F8 **DONE** · KEYS-ARGV **DONE** (help+README+doctrine) · CLI-ASCII still Max-gated |
...
| A-L3-SESSION-F8 | P3 | watch frame parse gaps vs `--frames N` | `cli.py` | **DONE** tip `397f11d` |
