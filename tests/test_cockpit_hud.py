...
def _labels(lines):
    return [text for text, _stale in lines[0::2]]


def _values(lines):
    return [text for text, _stale in lines[1::2]]


def _stales(lines):
    return [stale for _text, stale in lines[1::2]]
