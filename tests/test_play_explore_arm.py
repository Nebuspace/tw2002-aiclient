...
# WO-PLAY-EXPLORE-GATHER-DEFAULT-ON: default confirm states gather ON as
# `+dock`. Marker content pinned by literal in test_play_explore_flags.py.
_ON_ACTION = f"Explore {_explore_flags.DOCK_MARKER}"
