...
INTERVENTION_REASON_LABELS = {
    ...
    # WO-WIRE-CHAIN-STOP-REASON-LABELS — trade_driver ChainHold / early-return
    # stop_reason bases + session/trade_chain TradeChainRefused codes.
    # Qualified shapes (``code:detail…``) resolve via the base key below.
    "armed_off": "armed off",
